...
# リント
lint:
	docker run --rm -v $(PWD):/app -w /app golangci/golangci-lint:v2.12.1 golangci-lint run ./...

lint-fix:
	docker run --rm -v $(PWD):/app -w /app golangci/golangci-lint:v2.12.1 golangci-lint run --fix ./...
